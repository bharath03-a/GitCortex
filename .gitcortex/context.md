    ...
    - `pub folder src` :1
      - `pub folder mcp` :1
        - `pub file tour.rs` :1
          ...
          - `function seeded_tour` :132
          - `pub function render_markdown` :190
  ...
  - `pub folder integration` :1
    - `pub folder fixtures` :1
      ...
      - `pub file python_comprehensive.py` :1
        - `pub module python_comprehensive` :1
        ...
        - `pub struct AsyncService` :77
          - `pub async method fetch_user` :78
          - `pub async method save_user` :81
        - `pub function user_stream` :87
        - `pub async function async_user_stream` :92
        - `pub struct EventSystem` :99
          - `pub struct Event` :100
            - `method __init__` :101
          - `pub struct Handler` :104
            - `pub method handle` :105
