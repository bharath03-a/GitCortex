...
> Branch: `fix/multi-lang-query-bugs` · 873 definitions · SHA: `442fd181894c35c7b4dd517af30b89f6d3ed7e69`
  ...
  - `pub folder gitcortex-viz` :1
    ...
    - `pub folder src` :1
      - `pub file lib.rs` :1
        ...
        - `function build_cypher` :731
        - `function cypher_id` :763
        - `function cypher_str` :770
        - `function kind_dot_color` :774
        - `function repo_root` :794
